...
if %errorlevel% neq 0 (
    ...
    powershell -Command "Invoke-WebRequest -Uri 'https://nodejs.org/dist/v20.17.0/node-v20.17.0-x64.msi' -OutFile 'nodejs-installer.msi'"
    ...
    echo Node.js is already installed and ready to use!
)
